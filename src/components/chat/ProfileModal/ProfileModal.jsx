...
import { X, Camera, User, Lock, Loader2, CheckCircle2, LogOut, Pencil } from 'lucide-react';
    ...
    <div className={styles.overlay} onClick={onClose}>
      ...
      >
        ...
        <div className={styles.header}>
          ...
          <p>Update your profile information and security.</p>
        </div>
          ...
          <AnimatePresence mode="wait">
            {activeTab === 'profile' ? (
              ...
              >
                ...
                >
                  {loading ? <Loader2 size={18} className={styles.spinner} /> : success ? (
                    <motion.div
